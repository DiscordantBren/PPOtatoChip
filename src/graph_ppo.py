...
def graph_ppo_update(
    ...
    batch_data = Batch.from_data_list(rollout.observations).to(device)  # type: ignore[arg-type]
    global_current_node_idx = batch_data.current_node_idx + batch_data.ptr[:-1]
